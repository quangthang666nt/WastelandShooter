...
namespace Watermelon.SquadShooter
{
    public class CharacterBehaviour : MonoBehaviour, IEnemyDetector, IHealth, INavMeshAgent
    {
        ...
        private IControlBehavior joystick;
        ...
        public void Initialise()
        {
            ...
            joystick = Control.CurrentControl;
        ...
        private void Update()
        {
            ...
            if (joystick.IsInputActive && joystick.FormatInput.sqrMagnitude > 0.1f)
            {
                if (!isMoving)
                {
                    isMoving = true;
                ...
                float maxAlowedSpeed = Mathf.Clamp01(joystick.FormatInput.magnitude) * activeMovementSettings.MoveSpeed;
