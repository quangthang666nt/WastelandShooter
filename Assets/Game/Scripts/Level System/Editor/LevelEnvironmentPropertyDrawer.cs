...
{
    //[CustomPropertyDrawer(typeof(LevelEnvironment))]
    public class LevelEnvironmentPropertyDrawer : UnityEditor.PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            string[] enumNames = System.Enum.GetNames(typeof(LevelEnvironmentType));
